...
public class IntroduceRvAdapter extends RecyclerView.Adapter<IntroduceRvAdapter.ViewHolder> {
    ...
    public IntroduceRvAdapter(Context context, List<ChildListBean> list) {
